...
proc create_root_design { parentCell } {
  ...
  set io1_o [ create_bd_port -dir O io1_o ]
  set sck_i [ create_bd_port -dir I sck_i ]
  set spisel [ create_bd_port -dir I spisel ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_net -net axi_quad_spi_0_io1_o [get_bd_ports io1_o] [get_bd_pins axi_quad_spi_0/io1_o]
  ...
  connect_bd_net -net sck_i_1 [get_bd_ports sck_i] [get_bd_pins axi_quad_spi_0/sck_i]
  connect_bd_net -net spisel_1 [get_bd_ports spisel] [get_bd_pins axi_quad_spi_0/spisel]
