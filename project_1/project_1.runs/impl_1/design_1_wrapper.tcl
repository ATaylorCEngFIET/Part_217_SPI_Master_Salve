...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/hdl_projects/P217_spi/project_1/project_1.cache/wt [current_project]
  set_property parent.project_path C:/hdl_projects/P217_spi/project_1/project_1.xpr [current_project]
  set_property ip_output_repo C:/hdl_projects/P217_spi/project_1/project_1.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  add_files -quiet C:/hdl_projects/P217_spi/project_1/project_1.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files C:/hdl_projects/P217_spi/project_1/project_1.srcs/sources_1/bd/design_1/design_1.bd
  set_property is_locked true [get_files C:/hdl_projects/P217_spi/project_1/project_1.srcs/sources_1/bd/design_1/design_1.bd]
  set_param project.isImplRun false
  read_xdc C:/hdl_projects/P217_spi/project_1/project_1.srcs/constrs_1/new/const.xdc
  set_param project.isImplRun true
